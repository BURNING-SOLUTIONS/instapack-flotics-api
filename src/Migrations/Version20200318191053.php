 ...
 */
final class Version20200318191053 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract ADD vehicle VARCHAR(255) NOT NULL, DROP vehicleContracts');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract ADD vehicleContracts INT DEFAULT NULL, DROP vehicle');
