 ...
 */
final class Version20191229134906 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract ADD rental_agency_id INT NOT NULL, ADD instapack_group_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract DROP rental_agency_id, DROP instapack_group_id');
    }
}
