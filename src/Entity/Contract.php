<?php
 ...
 /**
  * @ApiResource(
  *     normalizationContext={"groups"={"get_contract","get_bill","get_clauses","vehicle_contract","get_vehicle"},"enable_max_depth"=true},
 ...
 class Contract
 {
   ...
   * @Groups({"get_bill","get_clauses","vehicle_contract","get_contract","get_vehicle"})
   *
   */
  private $id;
  ...
  /**
   * @ORM\Column(type="datetime")
   * @Groups({"get_bill","vehicle_contract","get_contract","get_vehicle"})
   */
  private $endDate;
